...
class SystemRole extends ModelBasic
{
     ...
     * @return array
     */
    public static function getRole($level = 0 ,$field='id,role_name',$business='0')
    {
        return self::where('status',1)->where('level','=',$level)->where('business','=',$business)->column($field);
    }
    ...
    public static function systemPage($where){
        ...
        $model = $model->where('business','=',$where['business']);
