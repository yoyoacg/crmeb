...
class ProgramTemplateService{
    ...
    public static function sendTemplate($openid,$templateId,array $data,$form_id = '',$link = null,$defaultColor = '')
    {
        $tempid = RoutineTemplateModel::where('tempkey',$templateId)->where('status',1)->value('tempid');
